...
export const PERSONAS: string[] = [
  'Marcus Aurelius', 'Elon Musk', 'Naval Ravikant', 'Laozi', 'Natalie Goldberg', 'Bruce Lee', 'Albert Camus', 'Carl Jung'
];

export const GUIDING_STAR_DEFAULTS: Record<Language, string[]> = {
  zh: ["马可·奥勒留", "马斯克", "纳瓦尔·拉维坎特", "老子", "娜塔莉·戈德堡", "李小龙", "加缪", "荣格"],
  en: ["Marcus Aurelius", "Elon Musk", "Naval Ravikant", "Laozi", "Natalie Goldberg", "Bruce Lee", "Albert Camus", "Carl Jung"],
  ja: ["マルクス・アウレリウス", "イーロン・マスク", "ナヴァル・ラヴィカント", "老子", "ナタリー・ゴールドバーグ", "ブルース・リー", "カミュ", "ユング"],
  ko: ["마르쿠스 아우렐리우스", "일론 머스크", "나발 라비칸트", "노자", "나탈리 골드버그", "이소룡", "카뮈", "융"],
  fr: ["Marc Aurèle", "Elon Musk", "Naval Ravikant", "Lao-Tseu", "Natalie Goldberg", "Bruce Lee", "Albert Camus", "Carl Jung"],
  es: ["Marco Aurelio", "Elon Musk", "Naval Ravikant", "Lao-Tse", "Natalie Goldberg", "Bruce Lee", "Albert Camus", "Carl Jung"],
  de: ["Mark Aurel", "Elon Musk", "Naval Ravikant", "Laotse", "Natalie Goldberg", "Bruce Lee", "Albert Camus", "Carl Jung"]
};
  ...
  zh: [
    {
      id: '1',
      title: '系统初始化日志_001',
      content: "第一天。城市的灯光比往常更亮。霓虹灯的嗡嗡声震耳欲聋。我已经成功绕过了公司防火墙，建立了这个安全节点。没人能在这里找到我的想法。",
    ...
    },
    {
      id: '2',
      title: '情感模块_异常波动',
      content: "原型失败了。神经链接一直拒绝宿主同步。我怀疑是第九课的特工进行了破坏。在这混乱的数据流中，我感到一种久违的恐惧... 这不该是代码能产生的情绪。我需要重新校准我的杏仁核模拟器。",
  ...
  en: [
    {
      ...
      content: "Day one. The city lights are brighter than usual. The hum of neon is deafening. I've successfully bypassed the corporate firewall and established this secure node. No one can find my thoughts here.",
      createdAt: Date.now() - 86400000 * 3,
      tags: ['CAREER', 'GROWTH'],
      isLocked: false,
      isEncrypted: false,
    ...
    },
    {
      ...
      content: "The prototype failed. The neural link keeps rejecting host synchronization. I suspect sabotage by agents of the Ninth Lesson. In this chaotic data stream, I feel a long-forgotten fear... This is not an emotion code should produce. I need to recalibrate my amygdala simulator.",
      createdAt: Date.now() - 3600000,
      tags: ['CAREER', 'FAMILY'],
      isLocked: false,
      isEncrypted: false,
...
export const PRESET_PRINCIPLES: Record<Language, { source: string; text: string; }[]> = {
  zh: [
    ...
    { source: "马可·奥勒留", text: "你拥有掌控自己内心的力量，而不是外部事件。意识到这一点，你将找到力量。" },
    { source: "弗里德里希·尼采", text: "知道为什么而活的人，便能生存。" },
    { source: "维克多·弗兰克尔", text: "在刺激与反应之间，有一个空间。在那个空间里，我们有选择反应的自由和力量。" },
  ...
  en: [
    ...
    { source: "Albert Camus", text: "Real generosity towards the future lies in giving all to the present." },
    { source: "Marcus Aurelius", text: "You have power over your mind - not outside events. Realize this, and you will find strength." },
    { source: "Friedrich Nietzsche", text: "He who has a why to live for can bear almost any how." },
    { source: "Viktor Frankl", text: "Between stimulus and response there is a space. In that space is our power to choose our response." },
    ...
    { source: "Baruch Spinoza", text: "I have striven not to laugh at human actions, not to weep at them, nor to hate them, but to understand them." },
    ...
    { source: "Michel de Montaigne", text: "The greatest thing in the world is to know how to belong to oneself." },
    { source: "Seneca", text: "We suffer more often in imagination than in reality." },
    { source: "Rollo May", text: "Freedom is man's capacity to take a hand in his own development." },
    { source: "Epictetus", text: "We cannot choose our external circumstances, but we can always choose how we respond to them." },
    { source: "Søren Kierkegaard", text: "Life can only be understood backwards; but it must be lived forwards." },
    { source: "Arthur Schopenhauer", text: "Life swings like a pendulum backward and forward between pain and boredom." },
    { source: "Delphic Maxim", text: "Know thyself." },
    { source: "Wang Yangming", text: "It is easy to defeat the thief in the mountain, but difficult to defeat the thief in your heart." },
    { source: "Erich Fromm", text: "Love is not a resting place, it is a moving, growing, working together." },
    ...
    { source: "Jorge Luis Borges", text: "Time is a river which sweeps me along, but I am the river." },
    { source: "Rabindranath Tagore", text: "Let your life lightly dance on the edges of Time like dew on the tip of a leaf." },
    ...
    { source: "Somerset Maugham", text: "He was looking at the moon and didn't see the sixpence at his feet." },
...
export const LIFE_PRINCIPLES: Record<Language, { year: number; text: string; date?: string }[]> = {
  zh: [
    ...
    { year: 2024, date: "2024.01.20", text: "请务必选择真实，纯粹，这是探寻你自己道路的必要要素。" },
    ...
    { year: 2025, date: "2025.04.10", text: "掌控自我 = 掌控(思维+情绪+行动) - (偏见+短视+混乱)。" },
  ...
  en: [
    ...
    { year: 2023, date: "2023.07.05", text: "“Living towards death” is the most effective long-termism." },
    { year: 2023, date: "2023.08.18", text: "Courage, hope, patience, and focus are your best partners." },
    { year: 2023, date: "2023.09.30", text: "Thinking clearly, explaining plainly, and doing correctly." },
    { year: 2023, date: "2023.11.11", text: "If you want to grow, any environment is your training ground." },
    { year: 2023, date: "2023.12.05", text: "May the awareness of ignorance sustain your final hope." },
    { year: 2023, date: "2023.12.28", text: "Find the controllable optimal solution among uncertainties." },
    { year: 2024, date: "2024.01.20", text: "Choose truth and purity; they are necessary for your path." },
    { year: 2024, date: "2024.03.05", text: "Be profound when alone, be gentle when in a group." },
    { year: 2024, date: "2024.04.18", text: "True empathy is putting on the other person's shoes." },
    { year: 2024, date: "2024.05.30", text: "Choose actively, then focus, persist, record, and create." },
    ...
    { year: 2024, date: "2024.09.15", text: "Don't treat fate's gifts as chips; sense fate's call." },
    ...
    { year: 2025, date: "2025.02.15", text: "Relaxation is self-control after working to exhaustion." },
    { year: 2025, date: "2025.03.01", text: "When you cannot face yourself calmly, stay away." },
    { year: 2025, date: "2025.03.20", text: "Self-imagination without preference is self-slaughter." },
    { year: 2025, date: "2025.04.10", text: "Mastering self = Mastering (Thinking+Emotion+Action)." },
    { year: 2025, date: "2025.05.05", text: "Making people feel at ease is high-level leadership." },
